sap.ui.require(
	...
	function (formatter, ResourceModel) {
		...
		QUnit.test("Should return the translated texts", function (assert) {
			...
			//critical part in formatter.js: var resourceBundle = this.getView().getModel("i18n").getResourceBundle();

			//stub for .getModel("i18n")
			...
			//dependent object injection this -> oControllerStub
			// System under test
